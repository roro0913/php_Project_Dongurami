								...
								<div class="content content-right">
									...
									<!-- Content -->
										...
										<article class="box page-content">
											...
											<header>
												<h2>회원가입</h2>
												<p>join the donggrame</p>
												<h3>*은 필수 입력 항목입니다.</h3>
												<form>
												<table>
													<tr>
														<td>*아이디</td>
														<td><span><input style="width:75%;" type="text" name="id"></span>
															<span><input style="width:20%; height:13%; line-height:13%; font-size:17px;" type="button" value="중복확인" onclick="check_id()"></span></td>
													</tr>
													<tr>
														<td>*비밀번호</td>
													...
													<tr>
														<td>*닉네임</td>
														<td><span><input style="width:75%;" type="text" name="nick"></span>
													...
													<tr>
														<td>*이메일</td>
														<td><input type="text" id="email1" style="width:25%;">@<input type="text" id="email2" style="width:25%;"></td>
													</tr>
												</table>
												<input type="button" value="저장하기" onclick="check_input()" style="display:inline;">
												<input type="button" value="취소하기" onclick="reset_form()" style="display:inline;">
												</form>
											</header>
