							...
							<div class="3u 12u(mobile)">
								<div class="sidebar">
									...
									<!-- Sidebar -->
										...
										<!-- Recent Posts -->
											<section>
												...
												<ul class="divided">
													...
													<li>
														<article class="box post-summary">
															<h3><a href="left-sidebar.php">입부신청</a></h3>
														</article>
													</li>
													<li>
														<article class="box post-summary">
										...
										<!-- Something -->
											<section>
												<h2 class="major"><span>최근 활동 기록</span></h2>
												<a href="#" class="image featured"><img src="images/pic03.jpg" alt="" /></a>
												<p>
													A지역구 대회에서 입상<br/>
													홍익의 정신을 살리는 음악, 지구 시민을 위한 음악을 함께 만들어갈 끼, 재능, 열정 넘치는 힐링 아티스트를 발굴하는 오디션이 처음으로 열린다. 
													지구시민운동연합은 대한민국의 건국이념인 홍익인간 이화세계의 정신을 널리 전파하고 지구사랑을 실천할 '힐링아티스트'를 발굴한다.
												</p>
										...
										<!-- Something -->
											<section>
												<h2 class="major"><span>이 달의 행사</span></h2>
												<p>
													신입생 환영의 밤!
												</p>
												<a href="#" class="button alt">자세히 보기</a>
								...
								<div class="content content-right">
									...
									<!-- Content -->
										...
										<article class="box page-content">
											...
											<section>
												<span class="image featured"><img src="./images/black beat1.png" alt="black beat 배너" /></span>
												<p>
													댄스 동아리 < Freestep > 2기를 모집합니다!</br>
✔장르불문, 실력 무관 춤에 관심 있는 분</br>
✔춤 추는 사람들과 인연 만들고 싶으신 분</br>
✔무대에 올라 멋지게 공연 하고싶으신 분</br>
✔춤은 좋아하지만 쑥쓰러워 나서지 못하시는 분</br>
이러한 여러분들도 < FreeStep > 에 들어오세요!!
											...
											<section>
												<h3>동아리 연혁</h3>
												<p>
                                                     freestep은 볼링부로 시작을 했습니다.</br>
													 볼링부에서 춤동아리로 20xx년에 바뀌었으며 이후 춤동아리로서 다양한 활동을 하고 있습니다.
												</p>
												<p>
													1992년 - 뭐뭐함<br/>
													1995년 - 뭐뭐함<br/>
											...
											<section>
												...
												<p>
													저는 회장을 맡고 있는 A라고 합니다.<br/>
													이러이러한 정신으로 동아리를 운영하고 있으며, 동아리 신입들을 아끼고, 동료간의 친목을 어쩌구 저쩌구
													당부드립니다.
													좋은 활동으로 찾아 뵙겠습니다.
												</p>
											</section>
							...
							<div class="12u">
								...
								<!-- Features -->
									<section class="box features">
										<h2 class="major"><span>A Major Manu</span></h2>
										<div>
											<div class="row">
												<div class="3u 12u(mobile)">
													...
													<!-- Feature -->
														<section class="box feature">
															<a href="#" class="image featured"><img src="images/search2.png" alt="동아리 직접 검색하기" /></a>
															<h3><a href="#">검색하기</a></h3>
															<p>
